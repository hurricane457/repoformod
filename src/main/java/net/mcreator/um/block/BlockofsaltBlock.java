...
public class BlockofsaltBlock extends UmModElements.ModElement {
	@ObjectHolder("um:blockofsalt")
	public static final Block block = null;
	public BlockofsaltBlock(UmModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("um:blockofsalt_match"), () -> CustomRuleTest.codec);
